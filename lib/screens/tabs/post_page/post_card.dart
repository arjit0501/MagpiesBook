...
class PostCard extends StatefulWidget {
  ...
  const PostCard({Key? key, required this.uid, required this.idea , required this.postUid , required this.userPostId,
  required this.comments , required this.likes, required this.time})
      : super(key: key);
    ...
    return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (_, snapshot) {
          ...
          isSaved = j;
                     ...
                     'idea': widget.idea});
                     batch.set(tt4, { 'uid': widget.uid, 'postUid': widget.postUid, 'userPostId': widget.userPostId,
                       'idea': widget.idea});
                     batch.update(tt2,{ 'bookMarks':FieldValue.increment(1)});
                     batch.update(tt3,{ 'bookMarks':FieldValue.increment(1)});
